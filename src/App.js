...
class App extends Component {
   ...
   <a className="menu-link" href="#">History</a>
   <a className="menu-link" href="#">Be a member</a> */}
							<a
							...
							<a
								className='content-button status-action'
								href='https://pmny.in/QIpKtmF4WBBy'
								target='_blank'>
								{' '}
								Donate Now{' '}
							</a>
						...
						<div className='left-side'>
							...
							<div className='side-wrapper'>
								...
								<div className='side-menu'>
									...
									<a href='https://pmny.in/QIpKtmF4WBBy' target='_blank'>
									...
									<a href='https://forms.gle/AUdSB3QhUZvoyKN27' target='_blank'>
										<svg viewBox='0 0 512 512' fill='currentColor'>
							...
							<div className='side-wrapper'>
								<div className='side-title'>Achievements</div>
								<div className='side-menu'>
									<a href='#'>
										<svg viewBox='0 0 512 512' fill='currentColor'>
							...
							<div className='content-wrapper'>
								<Router>
									<Switch>
										...
										<Route exact path='/2021/dp/slots/:id?'>
											<Slots />
										</Route>
										<Route exact path='/'>
											<Redirect to='home' />
